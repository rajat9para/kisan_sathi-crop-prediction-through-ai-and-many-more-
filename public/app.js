...
if (!window.KISAAN_API_BASE) {
  try {
    ...
    if (urlApi) {
      ...
      window.KISAAN_API_BASE = stored || "https://kisaan-sathi-api.onrender.com";
    }
  } catch (e) { /* no-op */ }
}
...
function fallbackDynamicVoiceQuery(query, isEn) {
  ...
  // 12. General Fallback
    ...
    const topCrop = hub.crops?.[0]?.name_hi || "प्रमुख फसल";
    const topCropEn = hub.crops?.[0]?.name_en || "primary crop";
    answer = isEn
      ? `For your land in ${hub.district_en}, current soil pH is ${hub.soil.ph} and primary crop is ${topCropEn}. Ensure timely weed management, balanced NPK application, and monitor weather radar for rain alerts. For direct scientist guidance, call Kisan Call Center 1800-180-1551.`
      : `${hub.district_hi} क्षेत्र में आपकी मिट्टी का pH मान ${hub.soil.ph} है तथा मुख्य फसल ${topCrop} है। खरपतवार नियंत्रण, संतुलित पोषण और मौसम पूर्वानुमान के अनुसार कृषि कार्य करें। विशेषज्ञ वैज्ञानिक सलाह के लिए किसान कॉल सेंटर 1800-180-1551 पर संपर्क करें।`;
  }
